  ...
  const services = [
    {
      ...
      description: "We identify and select the right professionals for your organization, ensuring a perfect match of skills, culture, and performance expectations."
    },
    {
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      description: "We take care of your team's day-to-day operations, including HR management, payroll processing, and performance monitoring."
    },
    {
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      description: "We handle all local employment regulations, taxes, and legal obligations on your behalf—minimizing risk and ensuring full compliance."
    },
    {
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      description: "We design flexible outsourcing models tailored to your specific needs, offering scalable and cost-effective workforce solutions."
    }
  ];
